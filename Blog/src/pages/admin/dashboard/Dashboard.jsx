    ...
    return (
        <Layout>
            <div className="py-10">
                <div
                    ...
                    <div className="left">
                        <img
                            ...
                            src={'https://i.pinimg.com/736x/2f/15/f2/2f15f2e8c688b3120d3d26467b06330c.jpg'} alt="profile"
                        />
                    </div>
                    <div className="right">
                        <h1
                        ...
                        <h2
                            style={{ color: mode === 'dark' ? 'white' : 'black' }} className="font-semibold">shankarveena2004@gmail.com
                        </h2>
                        <h2
                            style={{ color: mode === 'dark' ? 'white' : 'black' }} className="font-semibold">
               ...
               {/* Line  */}
               <hr className={`border-2 ${mode === 'dark' ? 'border-gray-300' : 'border-gray-400'}`} /> {/* 2. Fixed unterminated template literal */}
                {/* Table  */}
                <div className="">
