                      ...
                      >
                        ...
                        <div className="p-6">
                          ...
                          <p className="leading-relaxed mb-3" style={{
                            ...
                            "Financial markets are essential for trading financial instruments, enabling capital formation, liquidity, and risk management, which drive economic growth. Understanding them is key to informed investing."
                          </p>
                        </div>
                      </div>
                    </div>
